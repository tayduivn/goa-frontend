const countries = [
  ...
  {"id": 25, "name": "Bolivia", "code": "BO"},
  {"id": 26, "name": "Bosnia and Herzegovina", "code": "BA"},
  {"id": 27, "name": "Botswana", "code": "BW"},
  {"id": 28, "name": "Bouvet Island", "code": "BV"},
  {"id": 29, "name": "Brazil", "code": "BR"},
  {"id": 30, "name": "British Indian Ocean Territory", "code": "IO"},
  {"id": 31, "name": "Brunei Darussalam", "code": "BN"},
  {"id": 32, "name": "Bulgaria", "code": "BG"},
  {"id": 33, "name": "Burkina Faso", "code": "BF"},
  {"id": 34, "name": "Burundi", "code": "BI"},
  {"id": 35, "name": "Cambodia", "code": "KH"},
  {"id": 36, "name": "Cameroon", "code": "CM"},
  {"id": 37, "name": "Canada", "code": "CA"},
  {"id": 38, "name": "Cape Verde", "code": "CV"},
  {"id": 39, "name": "Cayman Islands", "code": "KY"},
  {"id": 40, "name": "Central African Republic", "code": "CF"},
  {"id": 41, "name": "Chad", "code": "TD"},
  {"id": 42, "name": "Chile", "code": "CL"},
  {"id": 43, "name": "China", "code": "CN"},
  {"id": 44, "name": "Christmas Island", "code": "CX"},
  {"id": 45, "name": "Cocos (Keeling) Islands", "code": "CC"},
  {"id": 46, "name": "Colombia", "code": "CO"},
  {"id": 47, "name": "Comoros", "code": "KM"},
  {"id": 48, "name": "Congo", "code": "CG"},
  {"id": 49, "name": "Congo, The Democratic Republic of the", "code": "CD"},
  {"id": 50, "name": "Cook Islands", "code": "CK"},
  {"id": 51, "name": "Costa Rica", "code": "CR"},
  {"id": 52, "name": "Cote D\"Ivoire", "code": "CI"},
  {"id": 53, "name": "Croatia", "code": "HR"},
  {"id": 54, "name": "Cuba", "code": "CU"},
  {"id": 55, "name": "Cyprus", "code": "CY"},
  {"id": 56, "name": "Czech Republic", "code": "CZ"},
  {"id": 57, "name": "Denmark", "code": "DK"},
  ...
  {"id": 73, "name": "French Guiana", "code": "GF"},
  {"id": 74, "name": "French Polynesia", "code": "PF"},
  {"id": 75, "name": "French Southern Territories", "code": "TF"},
  {"id": 76, "name": "Gabon", "code": "GA"},
  {"id": 77, "name": "Gambia", "code": "GM"},
  {"id": 78, "name": "Georgia", "code": "GE"},
  {"id": 79, "name": "Germany", "code": "DE"},
  {"id": 80, "name": "Ghana", "code": "GH"},
  {"id": 81, "name": "Gibraltar", "code": "GI"},
  {"id": 82, "name": "Greece", "code": "GR"},
  {"id": 83, "name": "Greenland", "code": "GL"},
  {"id": 84, "name": "Grenada", "code": "GD"},
  {"id": 85, "name": "Guadeloupe", "code": "GP"},
  {"id": 86, "name": "Guam", "code": "GU"},
  {"id": 87, "name": "Guatemala", "code": "GT"},
  {"id": 88, "name": "Guernsey", "code": "GG"},
  {"id": 89, "name": "Guinea", "code": "GN"},
  {"id": 90, "name": "Guinea-Bissau", "code": "GW"},
  {"id": 91, "name": "Guyana", "code": "GY"},
  {"id": 92, "name": "Haiti", "code": "HT"},
  {"id": 93, "name": "Heard Island and Mcdonald Islands", "code": "HM"},
  {"id": 94, "name": "Holy See (Vatican City State)", "code": "VA"},
  ...
  {"id": 127, "name": "Macao", "code": "MO"},
  {"id": 128, "name": "Macedonia, The Former Yugoslav Republic of", "code": "MK"},
  ...
  {"id": 141, "name": "Micronesia, Federated States of", "code": "FM"},
  ...
  {"id": 153, "name": "Netherlands Antilles", "code": "AN"},
  ...
  {"id": 166, "name": "Palestinian Territory, Occupied", "code": "PS"},
  {"id": 167, "name": "Panama", "code": "PA"},
  {"id": 168, "name": "Papua New Guinea", "code": "PG"},
  {"id": 169, "name": "Paraguay", "code": "PY"},
  {"id": 170, "name": "Peru", "code": "PE"},
  {"id": 171, "name": "Philippines", "code": "PH"},
