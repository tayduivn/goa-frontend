<template>
  <div class="help">
    ...
    <p>&nbsp;</p>
    <p>El presente Política de Privacidad establece los términos en que TSL usa y protege la información que es
    ...
    <p>TSL está altamente comprometido para cumplir con el compromiso de mantener su información segura. Usamos los
    ...
    <p>Nuestro sitio web emplea las cookies para poder identificar las páginas que son visitadas y su frecuencia. Esta
      ...
      usted, a menos de que usted así lo quiera y la proporcione directamente, <a href="https://tab.do/es-co/agaval/"
                                                                                  target="_blank">visitas a una web </a>.
    ...
    <p>TSL Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier momento.</p>
  </div>
</template>
